...
- [ ] toolBox.vue 新增直线、曲线工具
- [ ] toolOption.vue 配置项（线宽、颜色）
- [ ] app.help.ts 实现直线绘制函数
- [ ] app.help.ts 实现贝塞尔曲线绘制函数
- [ ] App.vue 实现直线预览机制
- [ ] App.vue 实现曲线多步骤交互 + 状态管理
...
- [ ] toolBox.vue 新增填充工具
- [ ] toolOption.vue 添加配置项（颜色、容差滑块）
- [ ] app.help.ts 实现扫描线填充算法
- [ ] 处理边界情况和性能优化
- [ ] App.vue 集成填充工具逻辑
